...
#
#    docker-credential-gcr installer
#    Standalone method is recommended by Google Cloud:
#    https://cloud.google.com/container-registry/docs/advanced-authentication#standalone-helper
#    Provide the VERSION when running this script
#
#    Example: ./file.sh 2.1.0
#

# Variables to download the required tar file.
VERSION=$1
OS=linux
ARCH=amd64
...
install(){
  ...
  curl -fsSL "$URL" | tar xz --to-stdout docker-credential-gcr \
